...
public class Cartest {
	public static void main(String[] args) {
		...
		System.out.println(
				"Car 1: Model No = " + car1.getModelNo() +
				     ", Machine Type = " + car1.getMachine().getMachineType()+ 
				     ", Engine Type = " + car1.getMachine().getEngine().getEngineType() + 
				     ", Price = "+ car1.getMachine().getEngine().getPrice());
		System.out.println(
				...
				","+ " Machine Type = " + car2.getMachine().getMachineType()+ ","
				   + " Engine Type = " + car2.getMachine().getEngine().getEngineType() + ", "
					+ "Price = "+ car2.getMachine().getEngine().getPrice());
	}
}
